...
object RuntimeJournalConfigSpec {
  ...
  sealed trait RuntimeJournal {
    def name: String
    protected def configOverride: Config
  ...
  object RuntimeJournal {
    case object Journal1 extends RuntimeJournal {
      ...
      override protected def configOverride: Config =
        ConfigFactory.parseString(s"""
           |pekko.persistence.r2dbc.journal.connection-settings.connection-factory.database = "runtime_journal_1"
           |""".stripMargin)
    }
    case object Journal2 extends RuntimeJournal {
      ...
      override protected def configOverride: Config =
        ConfigFactory.parseString("""
          |pekko.persistence.r2dbc.journal.connection-settings.connection-factory.database = "runtime_journal_2"
          |""".stripMargin)
    }
  }
